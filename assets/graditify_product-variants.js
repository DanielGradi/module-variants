...
/***/ "./assets/graditify_component-product-variants.js":
/*!********************************************************!*\
  !*** ./assets/graditify_component-product-variants.js ***!
  \********************************************************/
...
/* harmony import */ var _graditify_variants_product__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./graditify_variants-product */ "./assets/graditify_variants-product.js");
...
class ProductVariants extends  HTMLElement {
  constructor() {
    ...
    this.variants = (0,graditify_utils__WEBPACK_IMPORTED_MODULE_0__.$Q)('.variants', this)
  }

  connectedCallback() {
    this.hiddenElement((0,graditify_utils__WEBPACK_IMPORTED_MODULE_0__.$Q)('.price-product-js', this))
    this.hiddenElement((0,graditify_utils__WEBPACK_IMPORTED_MODULE_0__.$Q)('.graditify_variants--images', this))
    ;(0,_graditify_variants_product__WEBPACK_IMPORTED_MODULE_1__.variantOnChange)(".graditify-variants", this);
  ...
  activePrice() {
    this.showElement((0,graditify_utils__WEBPACK_IMPORTED_MODULE_0__.$Q)('.price-product-js', this))
  }

  activeMedia() {
    this.showElement((0,graditify_utils__WEBPACK_IMPORTED_MODULE_0__.$Q)('.graditify_variants--images', this))
  }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ProductVariants);


/***/ }),

/***/ "./assets/graditify_variants-change.js":
/*!*********************************************!*\
  !*** ./assets/graditify_variants-change.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var graditify_api__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(graditify_api__WEBPACK_IMPORTED_MODULE_1__);
...
async function sectionHandle(handle, variantId) {
  const thisParent = (0,graditify_utils__WEBPACK_IMPORTED_MODULE_0__.$Q)('product-variants');

  if (!thisParent) return

  const htmlResponse = await (0,graditify_api__WEBPACK_IMPORTED_MODULE_1__.shopifyVariantByUrl)(
    `/products/${handle}`,
    variantId
  );
  const {
  ...
  const parentSpecific = (0,graditify_utils__WEBPACK_IMPORTED_MODULE_0__.$Q)(sectionRendering, (0,graditify_utils__WEBPACK_IMPORTED_MODULE_0__.stringToHTML)(htmlResponse))
  const variantPrice = priceSelector ? (0,graditify_utils__WEBPACK_IMPORTED_MODULE_0__.$Q)(priceSelector, parentSpecific) : null;
  const variantAvailable = (0,graditify_utils__WEBPACK_IMPORTED_MODULE_0__.$Q)(`${thisParent.tagName} [name="available"]`, parentSpecific);
  const button = (0,graditify_utils__WEBPACK_IMPORTED_MODULE_0__.$Q)(`${thisParent.tagName} ${buttonSubmit}`, parentSpecific);
  const imagesVariant = imagesChange ? (0,graditify_utils__WEBPACK_IMPORTED_MODULE_0__.$Q)(imagesChange, parentSpecific) : null; // PDTE DARLE SOPORTE
  const imagesVariantSticky = (0,graditify_utils__WEBPACK_IMPORTED_MODULE_0__.$Q)(`.graditify_variants--images img`, parentSpecific);
  console.log({button})
  return {
...
function updatePrice(variantPrice, sectionPrice) {
  const intoElementPrice = (0,graditify_utils__WEBPACK_IMPORTED_MODULE_0__.$Q)('product-variants .price-product-js')
...
function updateButton(available, parent, newText) {
  ...
  const button = (0,graditify_utils__WEBPACK_IMPORTED_MODULE_0__.$Q)(buttonSubmit, parent);
...
function updateVariantImage(imagesVariantSticky) {
  const imageVariantWrapper = (0,graditify_utils__WEBPACK_IMPORTED_MODULE_0__.$Q)('product-variants .graditify_variants--images')
 ...
 * @version 2.0
 */
 async function queryVariants({ target }) {
  ...
  const {
   ...
   const addcartBtn = (0,graditify_utils__WEBPACK_IMPORTED_MODULE_0__.$Q)(buttonSubmit, thisParent);
   const {
    value,
    dataset,
  } = (0,graditify_utils__WEBPACK_IMPORTED_MODULE_0__.$Q)('[name="id"]', thisParent);
  ...
  updatePrice(price, (0,graditify_utils__WEBPACK_IMPORTED_MODULE_0__.$Q)(priceSelector));
  updateVariantImage(imagesVariantSticky)

  if(images) updateSlider((0,graditify_utils__WEBPACK_IMPORTED_MODULE_0__.$Q)(sectionRendering), images)
}


/***/ }),

/***/ "./assets/graditify_variants-product.js":
/*!**********************************************!*\
  !*** ./assets/graditify_variants-product.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   variantOnChange: () => (/* binding */ variantOnChange)
/* harmony export */ });
/* harmony import */ var graditify_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! graditify-utils */ "./node_modules/graditify-utils/src/index.js");
/* harmony import */ var graditify_utils__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(graditify_utils__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _graditify_variants_change__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./graditify_variants-change */ "./assets/graditify_variants-change.js");
...
function selectVariant(parent) {
  ...
  ;(0,graditify_utils__WEBPACK_IMPORTED_MODULE_0__.$Q)('[name="id"]', thisParent).value = variantFilter[0].id
}
 ...
 function iterationOptions(parent) {
  return options(parent).forEach((option) => {
    ...
    option.addEventListener('change', (e) => {
      ...
      (0,_graditify_variants_change__WEBPACK_IMPORTED_MODULE_1__.queryVariants)(e);
    });
  });
}
 ...
 */
 const variantOnChange = (component, scope = null) => {
  const parents = (0,graditify_utils__WEBPACK_IMPORTED_MODULE_0__.$Qll)(component, scope);
...
/***/ "./node_modules/graditify-api/src/api/shopifyApi.js":
/*!**********************************************************!*\
  !*** ./node_modules/graditify-api/src/api/shopifyApi.js ***!
  \**********************************************************/
...
/***/ "./node_modules/graditify-api/src/index.js":
/*!*************************************************!*\
  !*** ./node_modules/graditify-api/src/index.js ***!
  \*************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

const { API } = __webpack_require__(/*! ./api/shopifyApi */ "./node_modules/graditify-api/src/api/shopifyApi.js")
...
const { formatMoney } = __webpack_require__(/*! ./utils/price */ "./node_modules/graditify-utils/src/utils/price.js")
...
const { $Q } = __webpack_require__(/*! ./query-selector */ "./node_modules/graditify-utils/src/utils/query-selector.js");
...
/***/ "./assets/graditify_product-variants-styles.scss":
/*!*******************************************************!*\
  !*** ./assets/graditify_product-variants-styles.scss ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
/*!*****************************************************!*\
  !*** ./assets/graditify_product-variants.module.js ***!
  \*****************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initialStickyCard: () => (/* binding */ initialStickyCard)
/* harmony export */ });
/* harmony import */ var _graditify_product_variants_styles_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./graditify_product-variants-styles.scss */ "./assets/graditify_product-variants-styles.scss");
/* harmony import */ var graditify_utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! graditify-utils */ "./node_modules/graditify-utils/src/index.js");
/* harmony import */ var graditify_utils__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(graditify_utils__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _graditify_component_product_variants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./graditify_component-product-variants */ "./assets/graditify_component-product-variants.js");
...
function validationMediaQuery(valid) {
  const {
    mediaQuery
  } = (0,graditify_utils__WEBPACK_IMPORTED_MODULE_1__.$Q)("product-variants").props
...
const observeActionSticky = (...args) => {
  const [entries] = args;
  const mainProduct = (0,graditify_utils__WEBPACK_IMPORTED_MODULE_1__.$Q)("main");
  const productVariants = (0,graditify_utils__WEBPACK_IMPORTED_MODULE_1__.$Q)("product-variants");
  const {
    variantsWrapper
  } = productVariants.props
  const productVariantsWrapper = (0,graditify_utils__WEBPACK_IMPORTED_MODULE_1__.$Q)(variantsWrapper)
...
*/
const initialStickyCard = (() => {
  const {
    intersectionElement
  } = (0,graditify_utils__WEBPACK_IMPORTED_MODULE_1__.$Q)("product-variants").props

  const sectionOne = (0,graditify_utils__WEBPACK_IMPORTED_MODULE_1__.$Q)(intersectionElement);
